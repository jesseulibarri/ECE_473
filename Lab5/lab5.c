...
char lcd_line1[16] = "LOCAL T";
char lcd_line2[16] = "REMOTE T";
...
void format_lcd_array(char *local_temp, char *remote_temp) {
...
string2lcd("Getting Temp.");  // sent initial alarm msg
